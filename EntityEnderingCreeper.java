...
public class EntityEnderingCreeper extends EntityMob
{
    /**
     * Time when this Endering Creeper was last in an active state (Messed up code here, probably causes Endering Creeper animation to go
     * weird)
     */
    private int lastActiveTime;

    /**
     * The amount of time since the Endering Creeper was close enough to the player to ignite
     */
    private int timeSinceIgnited;
    private int fuseTime = 10;

    /**
     * Counter to delay the teleportation of an Endering creeper towards the currently attacked target
     */
    private int teleportDelay = 0;
    private int field_70826_g = 0;
    
    /** Explosion radius for this Endering Creeper. */
    private int explosionRadius = 2;

    public EntityEnderingCreeper(World par1World)
    {
        super(par1World);
        this.texture = "/mob/enderingcreeper.png";
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new EntityAIEnderingCreeperSwell(this));
        ...
        this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityPlayer.class, 1280.0F));
        this.tasks.addTask(7, new EntityAILookIdle(this));
        this.targetTasks.addTask(8, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 2560.0F, 0, true));
    ...
    /**
     * Checks to see if this Endering Creeper should be attacking this player
     */
    ...
    public void onLivingUpdate()
    {
        ...
        this.moveSpeed = this.entityToAttack != null ? 6.5F : 1.3F;
        int var1;
    ...
    /**
     * Teleport the Endering Creeper to a random nearby position
     */
    ...
    /**
     * Teleport the Endering Creeper to another entity
     */
    ...
    public void onUpdate()
    {
        if (this.isEntityAlive())
        {
            ...
            int var1 = this.getEnderingCreeperState();
    ...
    /**
     * Returns true if the Endering Creeper is powered by a lightning bolt.
     */
    ...
    /**
     * Params: (Float)Render tick. Returns the intensity of the Endering Creeper's flash when it is ignited.
     */
    public float getEnderingCreeperFlashIntensity(float par1)
    {
    ...
    protected void dropRareDrop(int par1)
    {
        ...
        this.dropItem(Item.gunpowder.shiftedIndex, 3);
    }
    ...
    /**
     * Returns the current state of Endering Creeper, -1 is idle, 1 is 'in fuse'
     */
    public int getEnderingCreeperState()
    {
        return this.dataWatcher.getWatchableObjectByte(16);
    }

    /**
     * Sets the state of Endering Creeper, -1 to idle and 1 to be 'in fuse'
     */
    public void setEnderingCreeperState(int par1)
    {
